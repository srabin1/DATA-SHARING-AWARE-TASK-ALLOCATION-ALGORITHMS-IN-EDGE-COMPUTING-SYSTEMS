...
//copyright: https://www.geeksforgeeks.org/iterative-approach-to-print-all-permutations-of-an-array/
/////Usage: Integer[] arr = { 0, 1, 2 };
////
////        PermutationBuilder perm = new PermutationBuilder(arr);
////        perm.GetFirst();
////        while (perm.HasNext())
////        {
////            System.out.println(Arrays.deepToString(perm.GetNext()));
////        }
public class PermutationBuilder {
    ...
    public void setCurrentPermutation() {
        currentPermutation=new Integer[this.Indexes.length];
    ...
    // Constructor
    public PermutationBuilder(Integer arr[])
    {
        this.Arr = arr;
        this.Increase = -1;
