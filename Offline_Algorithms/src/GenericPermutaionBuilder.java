...
public class GenericPermutaionBuilder {
        ...
        private Task currentPermutation[];

        public Task[] getCurrentPermutation() {
            return currentPermutation;
        }
    public void setCurrentPermutation() {
        currentPermutation=new Task[this.Indexes.length];
        ...
        // Constructor
        public GenericPermutaionBuilder(Task arr[])
        {
            this.Arr = arr;
            this.Increase = -1;
        ...
        public List<Task[]> getAllPermutations(){
