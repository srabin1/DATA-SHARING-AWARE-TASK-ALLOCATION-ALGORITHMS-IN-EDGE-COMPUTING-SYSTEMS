...
/// AKA NaivePGreedy
public class NaivePGreedyAlgorithm extends GreedyAlgorithmBase {

    public NaivePGreedyAlgorithm(String inputFilePath) {
        super(inputFilePath);
    }

    public NaivePGreedyAlgorithm(Integer[][] taskDataTypeMatrix, Double[] requestItems, Double[] profitItems) {
        super(taskDataTypeMatrix, requestItems, profitItems);
    }

    public NaivePGreedyAlgorithm(Integer[][] taskDataTypeMatrix, Double[] requestItems, Double[] profitItems, Knapsack[] knapsackItems) {
